    ...
    <nav className="bg-white shadow-lg h-screen w-64 fixed">
      ...
      <ul className="mt-6 space-y-4 px-4">
        <li>
          ...
          >
            <span className="mr-2">🏠</span> My TRUEPrice
          </Link>
        </li>
        <li>
          <Link
            ...
            className="flex items-center text-gray-700 hover:text-blue-500"
          >
            <span className="mr-2">📤</span> Upload CSV
          </Link>
        </li>
        <li>
          <Link
        ...
        <li>
          <Link
            ...
            className="flex items-center text-gray-700 hover:text-blue-500"
          >
            <span className="mr-2">⬇️</span> Download Data
          </Link>
        </li>
        <li>
          <Link
        ...
        <li>
          <Link
            ...
            className="flex items-center text-gray-700 hover:text-blue-500"
          >
            <span className="mr-2">📊</span> Graph View
          </Link>
        </li>
        <li>
          <Link
            ...
            className="flex items-center text-gray-700 hover:text-blue-500"
          >
            <span className="mr-2">🌡️</span> Headroom Heatmap
          </Link>
        </li>
        <li>
          <Link
            ...
            className="flex items-center text-gray-700 hover:text-blue-500"
          >
            <span className="mr-2">💲</span> Price Desk
          </Link>
        </li>
      </ul>
